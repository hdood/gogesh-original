$(document).ready(function () {
    ...
    window.subscribeToChannel = function (contactID) {
        if (currentChannel) {
            console.log("unsubscribe:" + currentChannel);
            pusher.unsubscribe(currentChannel);
        }
        var channelName = "support." + contactID;
        currentChannel = channelName;
        var private = pusher.subscribe(channelName);
        console.log("subscribe:" + channelName);
        private.bind("chat", function (data) {
            console.log("Pusher listner");
            console.log(data);
            $.post("/contact/receive", {
                ...
                // $("#messages > .clearfix").last().after(res);
    ...
    const messageList = $("#contacts #contact");
