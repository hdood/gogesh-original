    ...
    $(function () {
      ...
      -------------------------------------*/
        if ($.fn.datepicker !== undefined) {
            ...
            $(".air-datepicker-month").datepicker({
                language: {
                    days: [
                        "الأحد",
                        "الاثنين",
      ...
      -------------------------------------*/
        if ($("#student-doughnut-chart").length) {
            const seller = $("#student-doughnut-chart").data("seller");
            const customer = $("#student-doughnut-chart").data("customer");
